 ...
 */
final class Version20210107224221 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE zoology ADD zoology_completelistofspecies TINYINT(1) NOT NULL');
    }
 ...
 //       $this->addSql('ALTER TABLE zoology DROP zoology_completelistofspecies');
    }
}
