 ...
 */
final class Version20210107181801 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE zoology ADD zoology_timeto DATETIME DEFAULT NULL');
    }
 ...
 //       $this->addSql('ALTER TABLE zoology DROP zoology_timeto');
    }
}
