 ...
 */
final class Version20210107172733 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE zoology ADD zoology_timefrom DATETIME DEFAULT NULL');
    }
 ...
 //       $this->addSql('ALTER TABLE zoology DROP zoology_timefrom');
    }
}
